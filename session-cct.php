...
require_once( SESSION_CCT_DIR_PATH . 'lib/class.session_cct.php' );
require_once( SESSION_CCT_DIR_PATH . 'lib/class.session_cct_module.php' );
require_once( SESSION_CCT_DIR_PATH . 'lib/class.session_cct_settings.php' );
require_once( SESSION_CCT_DIR_PATH . 'lib/class.session_cct_view.php' );
...
require_once( SESSION_CCT_DIR_PATH . 'module/pulse/class.pulse.php' );
