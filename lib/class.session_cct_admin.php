...
class Session_CCT_Admin {
	...
	public static function init() {
    	...
    	wp_register_script( 'scct-admin', SESSION_CCT_DIR_URL.'/assets/js/admin.js', array( 'jquery' ), '1.0', true );
    	wp_register_style(  'scct-admin', SESSION_CCT_DIR_URL.'/assets/css/admin.css' );
	}
	
	public static function load() {
		add_action( 'add_meta_boxes', array( __CLASS__, 'meta_box_remove' ), 15 );
		wp_localize_script( 'scct-admin', 'session_stream_data', apply_filters( "scct_localize_admin", array() ) );
